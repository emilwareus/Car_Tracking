# -*- coding: utf-8 -*-
"""
Created on Sun Oct 29 20:23:18 2017
...
class Track_car:
    ...
    def find_cars(img, ystart = 400, ystop = 656, scale = 2, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins):
